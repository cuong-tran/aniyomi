...
internal class ExtensionApi {
    ...
    private fun List<AnimeExtensionJsonObject>.toExtensions(repoUrl: String): List<Extension.Available> {
        return this
            .filter {
...
private val animeExtensionSourceMapper: (AnimeExtensionSourceJsonObject) -> Extension.Available.AnimeSource = {
